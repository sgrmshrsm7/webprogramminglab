...
public class Test2 {
    ...
    JButton button;
    JButton button1;
    String ans2[] = {"26", "6", "19", "48", "85"};
    int score = 0;
    Test2(String name)
    {
        frame = new JFrame("Test 2");
        mainpanel = new JPanel();
        mainlabel = new JLabel("Test 2", JLabel.CENTER);
        button = new JButton();
        button1 = new JButton();
            ...
            tlabel1 = new JLabel("Question 1          35 - 9     = ", JLabel.LEFT);
            ...
            tlabel2 = new JLabel("Question 2          42 / 7     = ", JLabel.LEFT);
            ...
            tlabel3 = new JLabel("Question 3          24 - 5     = ", JLabel.LEFT);
            ...
            tlabel4 = new JLabel("Question 4          12 * 4     = ", JLabel.LEFT);
            ...
            tlabel5 = new JLabel("Question 5          83 + 2     = ", JLabel.LEFT);
            ...
            button.addActionListener(new ActionListener(){
                ...
                {
                    if(t1.getText().equals(ans2[0]))
                        score = score + 5;
                    if(t2.getText().equals(ans2[1]))
                        score = score + 5;
                    if(t3.getText().equals(ans2[2]))
                        score = score + 5;
                    if(t4.getText().equals(ans2[3]))
                        score = score + 5;
                    if(t5.getText().equals(ans2[4]))
                        score = score + 5;
                    frame.dispose();
